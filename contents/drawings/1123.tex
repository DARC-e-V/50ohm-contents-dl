...
% Year: 2026
% Ring modulator, case 1: U2 > 0 and U3 = U1
\begin{circuitikz}[european, straight voltages]
    ...
    \begin{scope}[shift={($(bb.south west)+(0.75/\getDarcImageFactor,-2.1/\getDarcImageFactor)$)}]
        ...
        \pgfplotsinvokeforeach{0,...,12}{
            \fill[DARCblue!10]
                (axis cs:{2*#1*pi/10},-1)
                rectangle (axis cs:{(2*#1+1)*pi/10},1);
        }
