...
<indepth>
*APRS* (Automatic Packet Reporting System) ist ein digitales Verfahren im Amateurfunk, mit dem Positions-, Status- und Kurznachrichten von Funkamateuren automatisch per Funk übertragen, weitergeleitet und häufig auch über das Internet dargestellt werden, vgl. [APRS.fi](https://aprs.fi). Auf $\qty{144,800}{\mega\hertz}$ nutzen Funkamateure AFSK mit FM-Funkgeräten für APRS-Aussendungen, die von Digipeatern weitergeleitet werden. 
</indepth>
