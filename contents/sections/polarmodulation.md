...
Abbildung [ref:polar_modulator] zeigt das Blockschaltbild des Verfahrens. Dabei werden die beiden Signalkomponenten $I(t)$ und $Q(t)$ (wie sie im vorherigen Kapitel beschrieben wurden) in die momentane Amplitude $A(t)$ und die momentane Phase $\varphi(t)$ umgerechnet:
