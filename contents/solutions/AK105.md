...
$d_{{40}^\circ} = \frac{\sqrt{\qty{30}{\ohm} \cdot P_{{40}^\circ}}}{E} = \frac{\sqrt{\qty{30}{\ohm} \cdot 0,25 \cdot P_\mathrm{EIRP}}}{E} = \frac{\sqrt{0,25} \cdot \sqrt{\qty{30}{\ohm} \cdot P_\mathrm{EIRP}}}{E} = \sqrt{0,25} \cdot \frac{\sqrt{\qty{30}{\ohm} \cdot P_\mathrm{EIRP}}}{E} = 0,5 \cdot \frac{\sqrt{\qty{30}{\ohm} \cdot P_\mathrm{EIRP}}}{E} = 0,5 \cdot d$
