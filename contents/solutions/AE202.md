Aus dem Oszillogramm können die Trägeramplitude $\hat{U}_\mathrm{T}$ und die Amplitude der Modulation $\hat{U}_\mathrm{mod}$ abgelesen werden. Ein Kästchen entspricht dabei $\qty{3}{\volt}$.
