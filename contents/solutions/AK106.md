...
4. Der Grenzwert für den Personenschutzabstand ist: $E = \qty{28}{\volt/\meter}$
...
$d = \frac{\sqrt{\qty{30}{\ohm} \cdot \qty{164,1}{\watt}}}{\qty{28}{\volt/\meter}} = \frac{\qty{70,2}{\volt}}{\qty{28}{\volt/\meter}} \approx \qty{2,50}{\meter}$
